...
and parameter exploration (see code listing). 
...
beads. Segmentation is usual one of many steps in the process of
...
exploring existing algorithms for a solution may be suited with
SimpleITK. 
