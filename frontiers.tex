...
Interface Generator (SWIG) [Beazly2003], is open source and a powerful
...
[Gamma1995]. This approach is how SimpleITK encapsulates ITK filters
...
[Sutter1999]. It is a facade in that it provides a unified interface
...
[Ierusalimschy2006]. We chose it as the language for the source code
...
[Alexandrescu2001]. The runtime id of a pixel type, PixelIDValue, is
...
annotated source code [REF]. It is used as the source code annotation
...
[Brandt1994] and schizophrenia [Staal2000]. 

In this example we use SimpleITK’s VectorConfidenceConnected filter
[Ibanez2005] to segment an MRI data set from the Neuroimage Analysis
Center’s Multi-modality MRI-based Atlas of the Brain [Halle2013].
...
has been used for whole cell imaging [Murphy2011]. 
...
markers algorithm available in ITK [Beare2006], can be seen as
...
[Fedorov2012]. It is a free and open sound application with support
