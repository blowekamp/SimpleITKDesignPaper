...
\def\Address{$^{1}$Office of High Performance and Communication, National Library of Medicine, National Institutes of Health, Bethesda, MD, USA \\
...
capabilities of ITK to a larger audience. SimpleITK is licensed as
...
coronal slices from the MRI volumes is simple (See figure \ref{fig:02}
...
of SimpleITK's \textif{Show} method to visualize intermediate results. It was
