...
version for display (See figure \ref{fig:02}).
...
2 seed points, one in each half. For visualization purpose, we create
...
\lstinputlisting[language=Python, label=lst:04, caption={A Python script using SimpleITK to the
    multi-modal segemntation of the lateral ventricles.}]{VentricleSegment.py}
