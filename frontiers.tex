...
%All article types: you may provide up to 8 keywords; at least 5 are mandatory.
 \keyFont{ \section{Keywords:}  software design, Insight Toolkit, segmentation, software development, Image Processing Software, image processing and analysis }
\end{abstract}
...
languages. For example SWIG can provide an interface to a \testit{std::vector}
...
efficient direct access, however it use is inherently unsafe.
...
\textif{LabelMap} classes and supports  multiple dimensions and pixel
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:01} Figure
   \arabic{figure}.}{ Data flow diagram of SimpleITK's build process. Boxes represent data, while ovals are important processes. }
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:03} Figure
   \arabic{figure}.}{ Segmentation seeds in green on coronal cross sections of T1 volume. }
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:04} Figure
   \arabic{figure}.}{ Axial and coronal cross sections with the
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:05} Figure
   \arabic{figure}.}{ Volume rendering of segmented ventricle. }
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:06} Figure
   \arabic{figure}.}{ Slice from the gold bead volume with 5nm pixel resolution. The dense 100nm gold beads are bright while the embedded resin is dark.  }
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:07} Figure
   \arabic{figure}.}{ Gold bead segmentation results on the same slice
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:08} Figure
   \arabic{figure}.}{ Volume rendering of colorized labeled gold bead segmentation. }
\end{figure}
